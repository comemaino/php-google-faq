...
<body>
  ...
  $faqs = [
    [
      ...
      Per presentare una richiesta di rimozione, compila questo <a href='#'>modulo web</a>. Riceverai una risposta automatica che conferma la ricezione della tua richiesta. Dopodiché valuteremo il tuo caso (tieni presente che potrebbe occorrere un po' di tempo perché abbiamo già ricevuto tante richieste simili).
    ...
    [
      ...
      La società consociata Google che offre i servizi, tratta le tue informazioni ed è responsabile del rispetto delle leggi sulla privacy vigenti. Generalmente Google offre i propri servizi per i consumatori tramite una delle due società seguenti:</br></br>
        ...
        <li>
        Google LLC, con sede negli Stati Uniti, per il resto del mondo.</br></br>
        </li>
        </ol>
        </li>
        <li>
  ...
  <strong>Stabilire il paese associato al tuo account</strong></br></br>
